...
########################################################
# main.py:  A simple conversion from the PyTorch
#   version by yunjey to a TensorFlow implementation
#
# This file has been modified to remove reference to 
#   the second dataset, RaFD.
#
...
def main(config):
    ...
    solver = Solver(sess, celebA_loader, config)
